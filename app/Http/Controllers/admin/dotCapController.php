...
class dotCapController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            $res = dotCaps::find($id)->update($formData);
            if($res){
