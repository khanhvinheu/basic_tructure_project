...
class thongTinKhoaHocController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        try{
            ...
            if(@$formData['TextSearch']){
                array_push($query,['tenKhoaHoc', 'LIKE' , "%" . @$formData['TextSearch'] . "%"]);
            }
            if(@$formData['Hidden']){
                array_push($query,['Hidden', @$formData['Hidden']]);
            }
            $res = thongTinKhoaHocs::where($query)
    ...
    public function store(Request $request)
    {
        ...
        try{
            $formData = $request->post();
            $res = thongTinKhoaHocs::create($formData);
            if($res){
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            $res = thongTinKhoaHocs::find($id)->update($formData);
            if($res){
    ...
    public function destroy($id)
    {
        //
        try{
            $res = thongTinKhoaHocs::find($id)->delete();
            if($res){
