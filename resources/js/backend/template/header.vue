			...
			<div class="main-container container-fluid">
				<div class="main-header-left">
					...
					<div class="hor-logo">
						<a class="main-logo" href="index.html">
							<img src="/assetsSp/img/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
							<img src="/assetsSp/img/brand/logo-light.png" class="header-brand-img desktop-logo-dark"
								alt="logo">
						</a>
					</div>
				</div>
				<div class="main-header-center">
					<div class="responsive-logo">
						<a href="index.html"><img src="/assetsSp/img/brand/logo.png" class="mobile-logo" alt="logo"></a>
						<a href="index.html"><img src="/assetsSp/img/brand/logo-light.png" class="mobile-logo-dark"
								alt="logo"></a>
					</div>
									...
									<div class="dropdown-menu">
										<a href="javascript:void(0)" class="dropdown-item d-flex ">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="/assetsSp/img/flags/french_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="/assetsSp/img/flags/germany_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar me-3 align-self-center bg-transparent"><img
													src="/assetsSp/img/flags/italy_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar me-3 align-self-center bg-transparent"><img
													src="/assetsSp/img/flags/russia_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<a href="javascript:void(0)" class="dropdown-item d-flex">
											<span class="avatar  me-3 align-self-center bg-transparent"><img
													src="/assetsSp/img/flags/spain_flag.jpg" alt="img"></span>
											<div class="d-flex">
										...
										<div class="main-notification-list">
											<div class="media new">
												<div class="main-img-user online"><img alt="avatar"
														src="/assetsSp/img/users/5.jpg"></div>
											...
											<div class="media">
												<div class="main-img-user online"><img alt="avatar"
														src="/assetsSp/img/users/3.jpg"></div>
												<div class="media-body">
								...
								<!-- <div class="dropdown main-profile-menu">
									<a class="d-flex" href="javascript:void(0)">
										<span class="main-img-user"><img alt="avatar"
												src="/assetsSp/img/users/1.jpg"></span>
									</a>
									<div class="dropdown-menu">
										<div class="header-navheading">
