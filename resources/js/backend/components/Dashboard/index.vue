                ...
                <div class="card bg-primary custom-card card-box">
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <img src="/assetsSp/img/pngs/work3.png" alt="user-img">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="demo-avatar-group my-auto float-end">
                                                ...
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/3.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/4.jpg">
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="demo-avatar-group my-auto float-end">
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/5.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/6.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/7.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/8.jpg">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">37<i class=""></i></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-nowrap">
                                            <div class="demo-avatar-group my-auto float-end">
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/11.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/12.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/9.jpg">
                                                </div>
                                                <div class="main-img-user avatar-sm">
                                                    <img alt="avatar" class="rounded-circle"
                                                        src="/assetsSp/img/users/10.jpg">
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-center">37<i class=""></i></td>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <div class="row row-sm">
                    ...
                    <div class="col-6">
                        <img src="/assetsSp/img/pngs/work.png" alt="image" class="best-emp">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-auto">
                        <div class="mt-3">
                            <div class="">
                                <img alt="" class="ht-50"
                                    src="/assetsSp/img/media/project-logo.png">
                            </div>
                        </div>
                    </div>
                </div>
