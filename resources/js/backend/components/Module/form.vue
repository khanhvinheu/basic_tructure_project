<template>
    <div class="inner-body">
        ...
        <div class="page-header">
            <div>
                <h2 class="main-content-title tx-24 mg-b-5">FORM MODULE</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">User</a></li>
                    <li class="breadcrumb-item active" aria-current="page">FormModule</li>
                </ol>
            </div>
            <div class="d-flex">
                            ...
                            <div class="col-md-12">
                                <el-form label-position="right" :model="formData" :rules="rules" ref="formData"
                                    ...
                                    <el-form-item label="Module cha" prop="id_parent">
                                        <div class="form-group">
                                            <el-select style="width: 100%" v-model="formData.id_parent" size="large"
                                                filterable placeholder="Chọn danh mục cha">
                                    ...
                                    <el-form-item label="Type" prop="type">
                                        <div class="form-group">
                                            <el-select style="width: 100%" v-model="formData.type" size="large"
                                                filterable placeholder="Chọn loại module">
                                                <el-option v-for="item in listCategoryParent" :key="item.id"
                                                    :label="item.code + ' | ' + item.name" :value="item.id">
                                                </el-option>
                                            </el-select>
                                    ...
                                    <el-form-item label="Index" prop="index">
                                        <div class="form-group">
                                            <el-input v-model="formData.index" placeholder="Nhập index"
