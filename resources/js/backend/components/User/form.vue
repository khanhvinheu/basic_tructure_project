        ...
        <div class="page-header">
            <div>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">CreateUser</li>
                </ol>
            </div>
            <div class="d-flex">
                <div class="justify-content-center">
                    ...
                    <button @click="$router.push({ name: 'UserCreate' })" type="button"
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                            ...
                            <div class="col-md-12">
                                <el-form label-position="right" :model="formData" :rules="rules" ref="formData"
                                    ...
                                    <el-form-item v-if="!idUpdate" label="Password" prop="password">
                                        <div class="form-group">
                                            <el-input show-password type="password" validate-event
                                                placeholder="Nhập password" v-model="formData.password"></el-input>
                                        </div>
                                    </el-form-item>

                                    <el-form-item v-if="!idUpdate" label="Nhập lại password"
                                        prop="password_confirmation">
                                        <div class="form-group">
                                            <el-input show-password type="password" validate-event
                                                placeholder="Nhập lại password trùng với bên trên"
                                    ...
                                    <el-form-item label="Chọn quyền" prop="role_code">
                                        <div class="form-group">
                                            <el-select style="width: 100%" v-model="formData.role_code" size="large"
                                                filterable placeholder="Chọn quyền">
                                    ...
                                    <el-form-item label="Screen default" prop="id_module_default">
                                        <div class="form-group">
                                            <el-select v-if="listModule" style="width: 100%"
                                                v-model="formData.id_module_default" size="large" filterable
                                                placeholder="Chọn màn hình mặc định vào khi đăng nhập">
                                                <el-option v-for="item in listModule" :key="item.id"
                    ...
                    <div class="card-footer" style="display: flex; justify-content: end;">
                        <el-button v-show="!idUpdate" type="success" @click="create"><i class="el-icon-plus"></i> Lưu
                            lại
                        </el-button>
                        <el-button v-show="idUpdate" type="success" @click="update"><i class="el-icon-edit"></i>
                            Cập nhật
                        </el-button>
